      ...
      <div className="flex items-center justify-center flex-col md:flex-row ">
        <div className="flex-auto  md:w-32  sm:pl-0  overflow-visible">
          <form className="ml-2" onSubmit={handleSubmit} data-aos={"slide-up"}>
            ...
            >
              <FileDownloadDoneIcon /> Message envoyé
            </button>
          </form>
           {/* <div className="text-white" data-aos={"slide-up"}>
              <div className="mt-6"
                title="mail"
              >
                <MailOutlineIcon className="cursor-pointer hover:scale-105" /> <span>tokyronaldo98@gmail.com</span> 
              </div>
              <div className="mt-4"
                title="phone"
              >
                <CallIcon className="cursor-pointer hover:scale-105" /> <span>0341853194</span> 
              </div>
            </div>  */}
        </div>
        <div className="flex-auto w-full md:w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center mt-10">
            ...
            <div className="mt-6 italic text-sm font-medium text-blue-500 ">
              ...
              <span>2024 Tokimaharavo ronaldo</span>
            </div>
          </div>
        </div>
        <ToastContainer
